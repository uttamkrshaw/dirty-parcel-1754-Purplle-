    ...
    return (
        ...
        <SimpleGrid maxW="auto" bg='#EEEEEE'>
            <SimpleGrid columns={{sm:1, md:2}} spacing='40px' maxW='6xl' margin="auto" bg="#EEEEEE">
                ...
                <Box>
                    <Image src="https://media6.ppl-media.com/tr:dpr-2/mediafiles/ecomm/misc/1674109520_pb-gif-celeb_rosehip.gif?tr=f-gif" />
                </Box>
                <Box>
                ...
                <Box>
                    <Image src="https://media6.ppl-media.com/tr:w-640,ar-20557-9993,c-at_max,pr-true,dpr-2/mediafiles/ecomm/misc/1673953608_lakme-720x350.jpeg" />
                </Box>
                <Box>
